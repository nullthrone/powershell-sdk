...
| `tools/list`, `tools/call` | M1 (text), M3 (all content types, structured output) |
...
| `notifications/progress`, `notifications/cancelled`, `notifications/message` | M1 / M3 |
