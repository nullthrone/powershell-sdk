function Start-McpServer {
    ...
    .DESCRIPTION
        ...
        and capability violations 400 with the JSON-RPC error codes of the specification. The Origin header
    ...
    $transportObject = switch ($Transport) {
        ...
        'Http' { New-McpHttpServerTransport -Url $Url -AllowedOrigins $AllowedOrigins -MaxBodyBytes $MaxBodyBytes -KeepAliveSeconds $KeepAliveSeconds }
        default { $Endpoint }
    }
